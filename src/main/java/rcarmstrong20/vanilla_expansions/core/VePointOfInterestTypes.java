...
{
    private static final Constructor<PointOfInterestType> POINT_OF_INTEREST_CONSTRUCTOR = ObfuscationReflectionHelper
            .findConstructor(PointOfInterestType.class, String.class, Set.class, int.class, int.class);
    ...
    private static PointOfInterestType register(String name, Set<BlockState> blockState, int p_221051_2_,
            int p_221051_4_)
    {
        try
        {
            return register(name,
                    POINT_OF_INTEREST_CONSTRUCTOR.newInstance(name, blockState, p_221051_2_, p_221051_4_));
        }
