...
public class VeTileEntityType
{
    ...
    public static TileEntityType<VeFrameTileEntity> frame = register(VanillaExpansions.MOD_ID, "frame",
    ...
    private static <T extends TileEntity> TileEntityType<T> register(String id, String name,
