...
public class VeVillagerProfessions
{
    ...
    public static final VillagerProfession LUMBERJACK = register(VanillaExpansions.MOD_ID, "lumberjack",
            VePointOfInterestTypes.LUMBERJACK, SoundEvents.ENTITY_VILLAGER_WORK_MASON);
            ...
            SoundEvent sound)
    {
        ...
        try
        {
            profession = VILLAGER_POFESSION_CONSTRUCTOR.newInstance(id + ":" + name, pointOfInterest, ImmutableSet.of(),
                    ImmutableSet.of(), sound);
        }
