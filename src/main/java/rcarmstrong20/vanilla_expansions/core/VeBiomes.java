...
public class VeBiomes
{
	...
	private static final BlockState AIRITE_ORE = VeBlocks.airite_ore.getDefaultState();
	private static final BlockState NETHER_SMOKY_QUARTZ_ORE = VeBlocks.smoky_quartz_ore.getDefaultState();
	private static final BlockState NETHER_RUBY_ORE = VeBlocks.ruby_ore.getDefaultState();
	private static final BlockState BLUEBERRY_BUSH = VeBlocks.blueberry_bush.getDefaultState().with(VeBerryBushBlock.AGE, 3);
	private static final BlockState CRANBERRY_BUSH = VeBlocks.cranberry_bush.getDefaultState().with(VeBerryBushBlock.AGE, 3);
	private static final BlockState WITCHS_CRADLE = VeBlocks.witchs_cradle.getDefaultState().with(VeBerryBushBlock.AGE, 3);
	private static final BlockState VOID_LIQUID = VeBlocks.void_liquid.getDefaultState();
	private static final BlockState GRASS_BLOCK = Blocks.GRASS_BLOCK.getDefaultState();
	private static final BlockState PURPLE_MUSHROOM_BLOCK = VeBlocks.purple_mushroom_block.getDefaultState().with(HugeMushroomBlock.UP, Boolean.valueOf(true)).with(HugeMushroomBlock.DOWN, Boolean.valueOf(false));
	...
	public static void registerBiomes(final RegistryEvent.Register<Biome> event)
	{
		...
		addFeature(Decoration.SURFACE_STRUCTURES, VeFeature.TAIGA_CABIN.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG).func_227228_a_(Placement.NOPE.func_227446_a_(IPlacementConfig.NO_PLACEMENT_CONFIG)), TAIGA_BIOMES);
		addStructure(VeFeature.FOREST_CABIN, IFeatureConfig.NO_FEATURE_CONFIG, FOREST_BIOME);
		addFeature(Decoration.SURFACE_STRUCTURES, VeFeature.FOREST_CABIN.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG).func_227228_a_(Placement.NOPE.func_227446_a_(IPlacementConfig.NO_PLACEMENT_CONFIG)), FOREST_BIOME);
		addStructure(VeFeature.BIRCH_FOREST_CABIN, IFeatureConfig.NO_FEATURE_CONFIG, BIRCH_FOREST_BIOMES);
		addFeature(Decoration.SURFACE_STRUCTURES, VeFeature.BIRCH_FOREST_CABIN.func_225566_b_(IFeatureConfig.NO_FEATURE_CONFIG).func_227228_a_(Placement.NOPE.func_227446_a_(IPlacementConfig.NO_PLACEMENT_CONFIG)), BIRCH_FOREST_BIOMES);
