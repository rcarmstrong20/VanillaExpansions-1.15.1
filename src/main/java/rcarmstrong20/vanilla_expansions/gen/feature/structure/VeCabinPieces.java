...
{
    public static void init(TemplateManager templateManager, BlockPos blockPos, Rotation rotation,
            List<StructurePiece> list, VillageConfig config)
    {
        list.add(new VeCabinPieces.VePiece(templateManager, config.startPool, blockPos, rotation));
    }
    ...
    public static class VePiece extends TemplateStructurePiece
    {
        ...
        private void setupTemplate(TemplateManager templateManager)
        {
            ...
            PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation)
                    .setCenterOffset(new BlockPos(0, 0, 0)).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_BLOCK);
         ...
         */
        @Override
        public boolean create(IWorld world, ChunkGenerator<?> chunkGenerator, Random random,
