...
public class VeTurkeyBlock extends CakeBlock
{
    ...
    /**
     * If the cake can be eaten add the appropriate hunger and when it has one slice
     * left remove it from the world.
     *
     * @param world  This world.
     * @param pos    The block's position.
     * @param state  The state for the turkey.
     * @param player The player eating the cake.
     * @return Whether the cake was eaten ActionResultType.SUCCESS or
